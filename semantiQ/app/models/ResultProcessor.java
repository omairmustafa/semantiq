...
public class ResultProcessor {
	...
	private static Map<String, Integer> difficultyLevel = new HashMap<String, Integer>() {
        {
            put("Novice", 1);
            put("Easy", 2);
            put("Medium", 3);
	...
	public Semantics getSemantics (String text){
		...
		this.populateEntites(text, semantics);
	...
	private void populateEntites(String text, Semantics semantics) {
		
		EntityExtraction entityExtraction = new EntityExtraction();
		List<Entity> entities = entityExtraction.getEntities(text);
		semantics.setEntities(entities);
