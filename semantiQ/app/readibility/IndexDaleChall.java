...
public class IndexDaleChall implements IReadabilityIndex {
	...
	private List<String> removeCommonWords(String[] tokens) {

		ArrayList<String> wordList = new ArrayList<String>(Arrays.asList(tokens)); 
		for (String commonWord : this.getCommonWords())  {  

			if (wordList.contains(commonWord)) {
				wordList.remove(commonWord);
			}
		}
